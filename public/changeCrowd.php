...
?>
    <div class="container">
        <img class="logo" src="resources/images/logo.png" alt="KDG logo"><br>
        <a href="podiumdrukte.php"><img class="backArrowSmallMargin" src="resources/images/backArrow.png" alt="back arrow"></a>
